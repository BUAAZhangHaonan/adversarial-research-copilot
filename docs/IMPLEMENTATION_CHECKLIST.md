...
- [x] B2 Persistent CNY request reservations, 20 CNY stages and single 100 CNY validation parent.
...
- [x] D1 B01–B18 replacement implementation and section 11 deterministic engineering coverage; independent installed CLI outside repository. This does not include a real SSH-disconnect or elapsed-24-hour test.
...
- [ ] E3 Fixed-material direct-Pro comparison, holdout and anonymous evaluation (L4), budget permitting.
...
Latest verified code snapshot: 535357d08667ee192e246f8de0a126de0a544f0d, 283 tests passed in 52.08s, log work/tests-claim-source.log; wheel/sdist built from that git archive and installed-resource checks from /tmp in .venv-wheel passed. Documentation update starts from 3f6026f. Windows 282 tests/427.42s was an earlier snapshot. Historical code snapshots include 0f66f56 (263/48.55s), 2b8b79a (258/46.23s) and eda3965 (255/47.29s).
...
- [x] 535357d controlled-source wheel/sdist build and separate installation checked from /tmp: version 0.2.0, 15 semantic prompts, packaged report/config assets, OpenAI 2.54.0 and MCP 2.1.1. Logs: work/wheel-build-535357d.log, work/wheel-install-535357d.log, work/wheel-help-535357d.log; installed checks: work/check_installed.py.
- [ ] Record any actual SSH-disconnection and elapsed-24-hour validation separately from simulated restart/old-date tests.
