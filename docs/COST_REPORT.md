...
账本快照：2026-09-07T15:54:54.524324+00:00。唯一父账户 `arc-vnext-validation-20260907`，总限额 100.000000 元。

已结算估计 **57.412830–57.562384 元**；预留 0.000000 元，未知调用 0，剩余 42.437616 元。
...
| natural_runtime_versions_v2.develop | 25.000000 | 100 | 10.578891 | 10.578927 | 0.000000 | 0 |

总调用数：1671。模型请求分布：{"deepseek-v4-flash": 623, "deepseek-v4-pro": 56}；语义调用均为 max。
